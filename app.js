...
async function loadSiteData() {
    ...
    try {
        ...
        // Reviews list (any element with id="reviews-list"), capped at 6
        // with a "show more" reveal for the rest.
        ...
        if (reviewsWrap) {
            ...
            if (!reviewsSnap.empty) {
                ...
                if (showMoreBtn && i > 6) showMoreBtn.style.display = 'inline-block';
            }
        }
    } catch (err) {
...
async function submitPublicReview() {
    ...
    try {
        ...
        setTimeout(() => { document.getElementById('reviewModal').style.display = 'none'; statusEl.textContent = ''; }, 1800);
    } catch (err) {
